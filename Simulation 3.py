...
vpi = math.sqrt(2 * G * m3 * ((r_e) / (r_m * (r_e + r_m))))
vinf = vpi - v2
b = (G * m2 * (math.sqrt((((m_o*(vinf**2))/(G*m2))**2) + ((2*m_o*(vinf**2))/(G*m2))))/(vinf**2)) / SCALE
POINTS = [(400 + b, 0)]
PERFRAME = 15
H = 10
...
class ISS(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.rect = self.surf.get_rect(center=(440, 800))
        self.pos = vec(400 + b , -10000)
        self.tra = False
        self.p1 = True
        self.p2 = True
...
def eangle(r1,angle,dir):
    e = 1 + ((r1 * (vpi-v2)**2)/(G*m2))
    d = (math.asin(1/e))
    if dir == 1:
        if angle < d + 0.01 and angle > d - 0.01 :
            return True
        else:
            return False
    else:
...
while True:
    ...
    if eangle(dist(P1.x(), P1.y(), P2.x(), P2.y()),
               ...
               dire(P1.x(), P1.y(), P2.x(), P2.y())) == True:
        P1.deltav1(dist(P1.x(), P1.y(), P2.x(), P2.y()),
               angle(P1.x(), P1.y(), P2.x(), P2.y(), dire(P1.x(), P1.y(), P2.x(), P2.y())),
               dire(P1.x(), P1.y(), P2.x(), P2.y()))
        print(dist(P1.x(),P1.y(),P2.x(),P2.y()),b)
